...
Source: [`packages/extensions/agent-team-gate/src/types.ts:152`](../packages/extensions/agent-team-gate/src/types.ts)
...
Requires: `subagents` · `llm` · `subprocess` · `agentTeams`
...
Source: [`packages/experimental/agent-team-external-cli/src/index.ts:52`](../packages/experimental/agent-team-external-cli/src/index.ts)
...
Source: [`packages/llm/llm-omniroute/src/index.ts:26`](../packages/llm/llm-omniroute/src/index.ts)
...
Source: [`packages/extensions/terminal-herdr/src/index.ts:23`](../packages/extensions/terminal-herdr/src/index.ts)
...
- `@deepseek-ai/dsh-live-agent-view` — requires `agents` · `webServer` ([`packages/extensions/live-agent-view/src/index.ts`](../packages/extensions/live-agent-view/src/index.ts))
...
- `@deepseek-ai/dsh-skill-rome` — requires `skills` ([`packages/skill/skill-rome/src/index.ts`](../packages/skill/skill-rome/src/index.ts))
- `@deepseek-ai/dsh-storage` ([`packages/storage/storage/src/index.ts`](../packages/storage/storage/src/index.ts))
- `@deepseek-ai/dsh-subagent` ([`packages/subagent/subagent/src/index.ts`](../packages/subagent/subagent/src/index.ts))
- `@deepseek-ai/dsh-subprocess-local` ([`packages/subprocess/subprocess-local/src/index.ts`](../packages/subprocess/subprocess-local/src/index.ts))
- `@deepseek-ai/dsh-subscription-quota` — requires `webServer` ([`packages/extensions/subscription-quota/src/index.ts`](../packages/extensions/subscription-quota/src/index.ts))
...
- `@deepseek-ai/dsh-x-ui` — requires `agents` · `loader` · `sessions` · `terminals` · `webServer` ([`packages/extensions/dsh-x-ui/src/index.ts`](../packages/extensions/dsh-x-ui/src/index.ts))
