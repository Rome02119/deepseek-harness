...
flowchart LR
  ...
  pkg_terminal_herdr["terminal-herdr"]
  pkg_sandbox["sandbox"]
  ...
  pkg_notebooklm["notebooklm"]
  svc_notebooklm["ctx.notebooklm<br/>Google NotebookLM integration"]
  ...
  pkg_terminal_herdr --> svc_terminals
...
| `ctx.terminals` | `seam` | [`terminal`](../packages/terminal/terminal) | [`terminal-bash`](../packages/terminal/terminal-bash), [`terminal-herdr`](../packages/extensions/terminal-herdr) | [`tool-terminal`](../packages/terminal/tool-terminal) | - | 注册表负责精确到 Agent 的会话身份和清理；后端负责终端机制，tool-terminal 则提供限定于所有者作用域的模型接口。 |
...
| `ctx.notebooklm` | `core` | [`notebooklm`](../packages/extensions/notebooklm) | - | [`tools`](../packages/core/tools) | - | 通过本地 nlm CLI 管理笔记本发现、交互式问答对话、源索引以及智能体工具。 |
