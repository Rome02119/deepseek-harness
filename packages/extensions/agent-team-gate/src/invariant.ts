...
const PACKAGE_NAME = '@deepseek-ai/dsh-agent-team-gate'

/** Cordis companion plugin name. */
export const name = 'agent-team-gate-invariant'
...
export const install: InvariantInstaller = Object.assign((ctx: Context, fail: InvariantFailure) => {
